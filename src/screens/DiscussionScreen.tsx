...
export const DiscussionScreen: React.FC = () => {
  const { currentCategory, advancePhase, goToVoting } = useGameStore();
        ...
        <View style={styles.timerSection}>
          {!isTimerStarted ? (
            ...
            <Animated.View entering={FadeIn.duration(400)} style={styles.setupContainer}>
              <Text style={styles.setupLabel}>Discussion Time</Text>
        ...
        <View style={styles.instructions}>
          <View style={styles.instructionItem}>
            ...
            <Text style={styles.instructionText}>
              Everyone answers the prompt one by one
            </Text>
          </View>
          <View style={styles.instructionItem}>
            <Ionicons name="search-outline" size={24} color={colors.text.tertiary} />
            <Text style={styles.instructionText}>
              Listen carefully to find the imposter
            </Text>
          </View>
        </View>
